...
import {EditorView, Decoration, DecorationSet, WidgetType, GutterMarker, lineNumberWidgetMarker} from "@codemirror/view"
...
const conflictGutterMarker = new class extends GutterMarker {
  constructor() {
    super()
